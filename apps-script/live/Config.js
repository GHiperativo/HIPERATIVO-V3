...
const H = {
  ...
  CAD: {
    ...
    DATA_INICIO: 39,
    ULTIMA_AVAL: 40,
    // ── Integração complementar com o CRM SHE ───────────────────────────
    ID_SHE:        41,
    EMAIL_NORM:    42,
    WHATS_NORM:    43,
    SHE_PREENCHIDO:44,
...
function onOpen() {
  ...
  menu.addSubMenu(
    ui.createMenu('👤 Atletas')
      ...
      .addItem('🔄 Sincronizar CRM SHE agora', 'sincronizarCadastrosSHEPendentes')
      .addItem('⚡ Ativar cadastro SHE em tempo real', 'instalarIntegracaoSHECRMTempoReal')
  ...
  menu.addSubMenu(
    ui.createMenu('📧 Comunicação')
      ...
      .addItem('⚡ Ativar cadastro SHE em tempo real', 'instalarIntegracaoSHECRMTempoReal')
      .addItem('🩺 Diagnosticar integração SHE', 'diagnosticarIntegracaoSHECRM')
      .addSeparator()
  ...
  menu.addSubMenu(
    ui.createMenu('🔬 Análise & Rankings')
      ...
      .addItem('🧪 Revalidar qualidade das atividades', 'reclassificarQualidadeAtividades')
      .addSeparator()
  ...
  menu.addSubMenu(
    ui.createMenu('⚙️ Configurações')
      ...
      .addSeparator()
      .addItem('🕐 Ativar automações essenciais', 'configurarTriggers')
      .addSeparator()
      ...
      .addItem('🗂️ Organizar abas operacionais', 'organizarAbasOperacionais')
      .addItem('🛡️ Aplicar auditoria segura Etapas 1/2', 'aplicarAuditoriaEtapas12Segura')
      .addSeparator()
...
function removerTriggers(confirmacao) {
